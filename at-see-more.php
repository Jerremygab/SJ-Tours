                ...
                <div class="bg_container">
                    ...
                    <div class="more_grid">
                        ...
                        <div class="right_side">
                            ...
                            <div class="details">
                                Total views:
                                <p id="display_attractions_<?= $fetch_places['id']; ?>"><?= $fetch_places['views']; ?> <i class="uil uil-eye icons_"></i></p> 
                            </div>
                            <a href="gs-quickview.php?pid=<?= $fetch_places['id']; ?>">
                                <button id="<?= $fetch_places['id']; ?>" tbl="attractions" button class="visit_btn">Details</button>
                            </a>
                        </div>
                    </div>
                </div>
