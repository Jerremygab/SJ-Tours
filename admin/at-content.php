...
if(isset($_GET['delete'])){
   ...
   $delete_content_image = $conn->prepare("SELECT * FROM `attractions` WHERE id = ?");
   ...
   $delete_content = $conn->prepare("DELETE FROM `attractions` WHERE id = ?");
   $delete_content->execute([$delete_id]);
   header("Location: /sjtours/admin/at-content.php");
}
...
<section class="show-products">
   ...
   <?php
      $select_contents = $conn->prepare("SELECT * FROM `attractions`");
