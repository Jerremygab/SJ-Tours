...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            <span>IG Link  </span>
            <input type="text" class="box" required maxlength="500" placeholder="Enter IG Link" name="ig_link">
         </div>
         <div class="inputBox">
            <span>WEB Link  </span>
            <input type="text" class="box" required maxlength="500" placeholder="Enter WEB Link" name="web_link">
         </div>
         <div class="inputBox">
            <span>Gmail 1 </span>
         ...
         <div class="inputBox">
            <span>Gmail 2  </span>
            <input type="text" class="box" required maxlength="500" placeholder="Enter Gmail 2" name="gmail_link2">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <input type="text" class="box" required maxlength="12" placeholder="Enter Phone Number 2" name="phone_link2">
         </div>
         <div class="inputBox">
            <span>Map Link  </span>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         <a href="update_content.php?update=<?= $fetch_contents['id']; ?>" class="option-btn">update</a>
